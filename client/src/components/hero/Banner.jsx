...
const Bannerx = () => {
  return (
    <Banner>
      <div className="flex w-[calc(100%-2rem)] mt-5 flex-col justify-between rounded-lg border border-gray-100 bg-white p-4 shadow-sm dark:border-gray-600 dark:bg-gray-700 md:flex-row lg:max-w-7xl">
