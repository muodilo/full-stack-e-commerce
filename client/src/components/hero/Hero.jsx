...
const Hero = () => {
  ...
  return (
		<section className='lg:px-[7rem] md:px-[5rem] px-2 md:mt-7 '>
			<div className='grid lg:grid-cols-2 grid-cols-1 px-5 bg-blue-50 pb-5 rounded-xl border shadow animate-in fade-in zoom-in duration-500 '>
				<div className='grid md:grid-cols-2 grid-cols-1 md:mt-5 p-2'>
					<div className='text-center md:text-left  '>
						...
						<p className='lg:mt-7 md:mt-5 md:text-xl mt-1 pe-2'>
							...
							cumque odit illo pariatur velit neque temporibus ipsa. Illo, modi
							a?
						</p>
						<button className='btn btn-primary lg:mt-7 md:mt-10 mt-2 '>
							CONTACT US
						</button>
					</div>
					<img
